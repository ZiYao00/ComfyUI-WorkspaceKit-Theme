...
const LABELS = {
  en: {
    tabLabel: "🎨 Theme Lab",
    tabTooltip: "WorkspaceKit Theme Lab · Live theme tuning",
    standaloneTitle: "Theme Lab",
    standaloneTooltip: "WorkspaceKit Theme Lab · Live theme tuning",
    headerTitle: "Theme Lab",
    apply: "Apply Theme",
    groupView: "View",
  ...
  zh: {
    tabLabel: "🎨 主题",
    tabTooltip: "WorkspaceKit 主题实验室 · 实时调色",
    standaloneTitle: "主题",
    standaloneTooltip: "WorkspaceKit 主题实验室 · 实时调色",
    headerTitle: "主题实验室",
    apply: "应用主题",
    groupView: "视图控制",
    groupHistory: "历史",
